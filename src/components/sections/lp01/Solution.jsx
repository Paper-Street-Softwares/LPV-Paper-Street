    ...
    <SectionArea className="bg-secondary" paddingtop={true}>
      <SectionWrapper className="flex flex-col gap-[40px] desktop2:gap-0 desktop1:justify-between">
        <div className="w-full">
          ...
          <div className="flex flex-wrap desktop1:flex-row items-center w-full justify-center gap-[32px] mt-[28px] desktop1:mt-0 ">
            <HowltWorksCardLPV
              icon={
                <svg
        ...
        <MotionDivDownToUp className="w-[100%] desktop1:w-[415px] desktop2:w-[485px] flex justify-center desktop2:pt-[28px]">
          <div className="">
            <Button
